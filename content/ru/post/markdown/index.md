---
title: Markdown. Язык разметки для текстовых документов.
subtitle: Markdown. Язык разметки для текстовых документов.

# Summary for listings and search engines
summary: Markdown. Язык разметки для текстовых документов.
...
Основной синтаксис. Он очень простой: текст «оборачивается» в символы или они ставятся перед строкой.
